      ...
      <div className="container flex h-14 max-w-screen-2xl items-center justify-between">
        ...
        <div className="flex items-center gap-4">
              ...
              <SheetHeader>
                <SheetTitle asChild className="!text-left text-lg">
                  <Link className="flex items-center gap-2.5" href="/" onClick={() => setOpen(false)}>
                    <Image src="/logo.png" alt="Agent Foundry" width={728} height={728} className="w-7 h-7" />
                    <span className="font-bold">Agent Foundry</span>
                  </Link>
                </SheetTitle>
              </SheetHeader>
          ...
          <Link href="/" className="gap-2.5 items-center hidden md:flex">
            <Image src="/logo.png" alt="Agent Foundry" width={728} height={728} className="w-8 h-8" />
