      ...
      <div className="grid gap-6 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2">
        <div className="flex flex-col gap-8 lg:col-span-2">
          <div className="space-y-4">
            <div>
              <Image src="/logo.png" alt="Agent Foundry" width={256} height={256} className="w-7 h-7" />
            </div>
            ...
            <div className="flex flex-col gap-4 text-muted-foreground">
              <div className="flex gap-1.5 items-center">
                ...
                <a href="https://x.com/chris9753" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4">
                  @chris9753
                </a>
              </div>
            </div>
