...
export default function MyAgents() {
  ...
  return <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:px-6">
    <Alert>
      ...
      <AlertDescription>
        Please expect the service to be unstable and data lost as we are in the Alpha phase. We recommend <a href="https://github.com/chris9753/agent-foundry" className="underline underline-offset-4" target="_blank" rel="noopener noreferrer">self-hosting</a> the service.
      </AlertDescription>
    </Alert>
